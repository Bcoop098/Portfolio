...
public class MeterMinionScript : MonoBehaviour
{
    GameObject Target;
    Vector3 playerVel;
    ...
    float closureDistance = 3f;
    float hitRange = 0.5f;
    float closureThreshold = 0.05f;
    float fleeThreshold = 0.5f;// a float between 0 and 1 that determines when the the peasant flees
