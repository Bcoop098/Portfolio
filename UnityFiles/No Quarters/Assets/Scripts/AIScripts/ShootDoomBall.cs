...
public class ShootDoomBall : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        doomDirection = new Vector2(Direction.x, Direction.y);
    ...
    void Update()
    {
        transform.Translate(doomDirection.normalized * Time.deltaTime * speed);
    }
